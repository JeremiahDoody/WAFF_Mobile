...
namespace WAFF_Mobile
{
	...
	public class HomeScreenAdapter : BaseAdapter<MainTableItem01> 
	{
		...
		public override View GetView(int position, View convertView, ViewGroup parent)
		{
			...
			Console.WriteLine ("items[7].Name: " + items[7].Name);
			Console.WriteLine ("items[position]: " + items[position]);
			Console.WriteLine ("-------------------------------------");
...
//			view.FindViewById<ImageView>(Resource.Id.Image).SetImageResource(item.ImageResourceId);
			...
			Console.WriteLine ("HomeScreenAdapter >> GetView >> ImageButton #" + position + " item.Favorited:" + item.Favorited + ".");
